...
**GOTCHA!** Using the `.` notation to reference a column does not work in R. Try executing `mtcars.mpg`
...
**GOTCHA!** Using `[` returns a dataframe, so accessing the fifth element will throw an error because you have only one column **mpg** returned. See for yourself!
